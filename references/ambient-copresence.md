...
**Design** • **The Web**
Planted about 2 years ago • Last tended about 2 years ago
...
It's fairly easy to implement this nowadays. My friends over at [PartyKit](https://www.partykit.io/) have been exploring ideas ways to enable multiplayer experience with a few lines of code. For example, [Cursor Party](https://cursor.party/) is a one-line script that gives every visitor to your webpage their own cursor, country flag, and chatbox.
...
[Hypothesis](https://web.hypothes.is/) is a browser plugin that does this much better. It allows you to highlight and take notes on any content on the web. It works as an annotation layer over the internet. But one that everyone shares.
...
Striking the balance between drawing too much attention to other people's actions and providing ambient companionship is tricky, but we manage it in physical spaces. We just need to keep exploring patterns for our digital ones too.

---

## References and Further Reading

- [Designing multiplayer apps with patterns from architecture](https://interconnected.org/home/2023/08/15/spatial_software) – Matt Webb
- [Ambient Intimacy](https://www.disambiguity.com/ambient-intimacy/) – Leisa Reichelt, 2007

---

## Mentions around the web

**Jeremy Felt** • [iwebthings.joejenett.com](https://iwebthings.joejenett.com)
mentioned in *a.few.in.the.meantime 05-01-24* • May 01, 2024

> random | text-mode.org 🖥️ "Text graphics: ASCII, PETSCII and its distant relatives." Ambient Co-presence 👥 "Creating a subtle, peripheral, and synchronous sense of shared space and context on the web" A Website Is A Room ⇦ "...I realized that certain websites give me a se

---

**Want to stay up to date?**
[Subscribe via RSS Feed](https://maggieappleton.com/rss.xml)

---

© 2026 Maggie Appleton
[The Garden](/) • [Essays](/essays) • [About](/about) • [Notes](/notes) • [Now](/now) • [Patterns](/patterns) • [Podcasts](/podcasts) • [Talks](/talks) • [Smidgeons](/smidgeons) • [Colophon](/colophon) • [Library](/library)
