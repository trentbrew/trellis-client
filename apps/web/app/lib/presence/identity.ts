/** Per-tab presence identity (sessionStorage). */
const IDENTITY_KEY = 'trellis-web-presence-identity'

const ADJECTIVES = [
  'Agile', 'Bold', 'Calm', 'Clever', 'Daring', 'Eager', 'Feisty', 'Gentle',
  'Happy', 'Jolly', 'Keen', 'Lively', 'Merry', 'Noble', 'Quick', 'Sharp',
  'Sunny', 'Swift', 'Wise', 'Zesty',
]

const ANIMALS = [
  'Badger', 'Bear', 'Crane', 'Dolphin', 'Eagle', 'Falcon', 'Fox', 'Hawk',
  'Koala', 'Lynx', 'Otter', 'Panda', 'Raven', 'Tiger', 'Wolf', 'Zebra',
]
