<script setup lang="ts">
  ...
  import { MinusIcon, PlusIcon, LocateFixedIcon } from 'lucide-vue-next'
...
<template>
  <div
    :class="
      cn(
        'flex items-center justify-between gap-2 border-b bg-background/80 px-2 py-2 backdrop-blur-sm',
        props.className,
      )
    ">
    ...
    <div class="flex items-center gap-2">
      <UiButton
        data-gantt-toolbar="now"
        variant="outline"
        size="sm"
        :disabled="!gantt.scrollToToday"
        @click="handleJumpToToday">
