<script lang="ts" setup>
  ...
  const props = defineProps<TagsInputInputProps & { class?: ClassNameValue }>()
...
<template>
  <TagsInputInput data-slot="tags-input-input" v-bind="forwarded" :class="styles({ class: props.class })">
    <slot />
  </TagsInputInput>
</template>
