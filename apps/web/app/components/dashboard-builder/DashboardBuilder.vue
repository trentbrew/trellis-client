      ...
      <div class="flex items-center justify-between px-6 py-4 border-b border-accent/20 bg-accent/5 shrink-0">
        <div class="flex items-center gap-3">
          <div class="p-1.5 rounded-md bg-accent/20">
            <Icon name="lucide:layout-dashboard" class="w-5 h-5 text-accent-foreground" />
          </div>
          <div>
      ...
      <div class="flex-1 flex overflow-hidden">
        ...
        <div class="flex-1 overflow-y-auto bg-muted/30 p-6">
          <div class="mx-auto max-w-5xl">
            ...
            <div
              v-if="localDashboard.widgets.length === 0"
              class="text-center py-16 border-2 border-dashed rounded-lg bg-background">
