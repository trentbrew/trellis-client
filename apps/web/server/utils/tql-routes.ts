...
const workspaceRoute: RouteDefinition = {
  ...
  sidebarSections: [
    ...
    },
    {
      ...
      items: [
        ...
        { routePath: '/workspace/files', label: 'Files & Media', icon: 'lucide:paperclip', entityType: 'file' },
  ...
  children: [
    ...
    },
    {
      ...
      pageVariant: 'browse',
      projectionTypes: ['card-grid', 'list', 'table'],
      meta: { title: 'Files & Media', description: 'Uploaded files and media' },
    },
    {
