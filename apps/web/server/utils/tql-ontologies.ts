...
import type { SchemaDefinition, PropertyValueSpecification, WorkspaceConfig } from '@turtle.tech/tql'
...
const emailOntology: SchemaDefinition = {
  ...
  propertyFieldIds: ['from', 'to', 'date', 'labelIds', 'tags'],
  defaultSortField: 'date',
  searchFields: ['title', 'subject', 'from', 'to', 'snippet', 'bodyText'],
  fields: [
    ...baseFields(),
    ...documentFields(),
    f('subject', 'rich_text'),
